...
(function() {
  var configuration, createSignalingChannel, dc, gotDescription, iceCandidates, localStream, pc, pubnub, remoteView, selfView, signalingChannel, start, uuid;
  ...
  start = function(isCaller) {
    ...
    dc.onmessage = function(event) {
      return console.log("Got message: " + event.data);
    };
    ...
    pc.onaddstream = function(evt) {
      ...
      sendMessage = function() {
        return dc.send('Hello World!');
      };
      return setTimeout(sendMessage, 10000);
    };
    if (isCaller) {
